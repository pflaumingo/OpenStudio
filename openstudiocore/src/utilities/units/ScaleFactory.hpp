...
extern template class UTILITIES_API openstudio::Singleton<openstudio::ScaleFactorySingleton>;

extern template struct UTILITIES_API std::pair<openstudio::ScaleConstant,double>;
