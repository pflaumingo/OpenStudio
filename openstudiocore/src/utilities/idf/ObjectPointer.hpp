...
extern template struct UTILITIES_API openstudio::ObjectPointer<unsigned, openstudio::Handle>;
extern template struct UTILITIES_API openstudio::ObjectPointer<openstudio::Handle, unsigned>;
extern template struct UTILITIES_API openstudio::ObjectPointer<openstudio::Handle, openstudio::Handle>;

extern template class UTILITIES_API std::vector<openstudio::UHPointer>;
extern template class UTILITIES_API std::vector<openstudio::HUPointer>;
extern template class UTILITIES_API std::vector<openstudio::HHPointer>;
