...
extern template class boost::optional<openstudio::model::LifeCycleCostParameters>;
template<> std::vector<openstudio::model::LifeCycleCostParameters>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::LifeCycleCostParameters>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::LifeCycleCostParameters>;
