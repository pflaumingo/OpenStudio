...
extern template class boost::optional<openstudio::model::CoilHeatingLowTempRadiantVarFlow>;
template<> std::vector<openstudio::model::CoilHeatingLowTempRadiantVarFlow>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::CoilHeatingLowTempRadiantVarFlow>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::CoilHeatingLowTempRadiantVarFlow>;
