...
extern template class boost::optional<openstudio::model::CurveTriquadratic>;
template<> std::vector<openstudio::model::CurveTriquadratic>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::CurveTriquadratic>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::CurveTriquadratic>;
