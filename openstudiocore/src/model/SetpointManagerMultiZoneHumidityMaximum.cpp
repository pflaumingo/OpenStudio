...
template class boost::optional<openstudio::model::SetpointManagerMultiZoneHumidityMaximum>;
template class std::vector<openstudio::model::SetpointManagerMultiZoneHumidityMaximum>;
