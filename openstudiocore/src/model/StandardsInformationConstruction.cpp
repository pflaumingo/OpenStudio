...
template class boost::optional<openstudio::model::StandardsInformationConstruction>;
template class std::vector<openstudio::model::StandardsInformationConstruction>;
