...
template class boost::optional<openstudio::model::ZoneHVACBaseboardRadiantConvectiveWater>;
template class std::vector<openstudio::model::ZoneHVACBaseboardRadiantConvectiveWater>;
