...
template class boost::optional<openstudio::model::AirTerminalSingleDuctVAVHeatAndCoolNoReheat>;
template class std::vector<openstudio::model::AirTerminalSingleDuctVAVHeatAndCoolNoReheat>;
