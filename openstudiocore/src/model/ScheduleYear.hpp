...
extern template class boost::optional<openstudio::model::ScheduleYear>;
template<> std::vector<openstudio::model::ScheduleYear>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::ScheduleYear>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::ScheduleYear>;
