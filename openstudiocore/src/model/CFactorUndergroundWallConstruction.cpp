...
template class boost::optional<openstudio::model::CFactorUndergroundWallConstruction>;
template class std::vector<openstudio::model::CFactorUndergroundWallConstruction>;
