...
template class boost::optional<openstudio::model::HeatPumpWaterToWaterEquationFitCooling>;
template class std::vector<openstudio::model::HeatPumpWaterToWaterEquationFitCooling>;
