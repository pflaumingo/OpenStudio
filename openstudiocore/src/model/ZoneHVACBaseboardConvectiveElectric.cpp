...
template class boost::optional<openstudio::model::ZoneHVACBaseboardConvectiveElectric>;
template class std::vector<openstudio::model::ZoneHVACBaseboardConvectiveElectric>;
