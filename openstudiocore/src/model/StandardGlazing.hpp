...
extern template class boost::optional<openstudio::model::StandardGlazing>;
template<> std::vector<openstudio::model::StandardGlazing>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::StandardGlazing>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::StandardGlazing>;
