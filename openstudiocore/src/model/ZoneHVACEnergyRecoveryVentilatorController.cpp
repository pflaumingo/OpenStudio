...
template class boost::optional<openstudio::model::ZoneHVACEnergyRecoveryVentilatorController>;
template class std::vector<openstudio::model::ZoneHVACEnergyRecoveryVentilatorController>;
