...
template class boost::optional<openstudio::model::ZoneHVACPackagedTerminalHeatPump>;
template class std::vector<openstudio::model::ZoneHVACPackagedTerminalHeatPump>;
