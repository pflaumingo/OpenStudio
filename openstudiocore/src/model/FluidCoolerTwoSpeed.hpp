...
extern template class boost::optional<openstudio::model::FluidCoolerTwoSpeed>;
template<> std::vector<openstudio::model::FluidCoolerTwoSpeed>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::FluidCoolerTwoSpeed>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::FluidCoolerTwoSpeed>;
