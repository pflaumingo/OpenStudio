...
template class boost::optional<openstudio::model::ZoneControlThermostatStagedDualSetpoint>;
template class std::vector<openstudio::model::ZoneControlThermostatStagedDualSetpoint>;
