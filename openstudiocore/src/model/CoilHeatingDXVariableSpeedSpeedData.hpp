...
extern template class boost::optional<openstudio::model::CoilHeatingDXVariableSpeedSpeedData>;
template<> std::vector<openstudio::model::CoilHeatingDXVariableSpeedSpeedData>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::CoilHeatingDXVariableSpeedSpeedData>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::CoilHeatingDXVariableSpeedSpeedData>;
