...
template class boost::optional<openstudio::model::RefrigerationGasCoolerAirCooled>;
template class std::vector<openstudio::model::RefrigerationGasCoolerAirCooled>;
