...
template class boost::optional<openstudio::model::CoolingTowerPerformanceYorkCalc>;
template class std::vector<openstudio::model::CoolingTowerPerformanceYorkCalc>;
