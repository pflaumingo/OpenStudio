...
template class boost::optional<openstudio::model::SolarCollectorPerformanceIntegralCollectorStorage>;
template class std::vector<openstudio::model::SolarCollectorPerformanceIntegralCollectorStorage>;
