...
template class boost::optional<openstudio::model::CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFit>;
template class std::vector<openstudio::model::CoilHeatingWaterToAirHeatPumpVariableSpeedEquationFit>;
