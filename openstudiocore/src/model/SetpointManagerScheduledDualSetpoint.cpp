...
template class boost::optional<openstudio::model::SetpointManagerScheduledDualSetpoint>;
template class std::vector<openstudio::model::SetpointManagerScheduledDualSetpoint>;
