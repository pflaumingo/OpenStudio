...
extern template class boost::optional<openstudio::model::BuildingStory>;
template<> std::vector<openstudio::model::BuildingStory>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::BuildingStory>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::BuildingStory>;
