...
template class boost::optional<openstudio::model::EvaporativeCoolerIndirectResearchSpecial>;
template class std::vector<openstudio::model::EvaporativeCoolerIndirectResearchSpecial>;
