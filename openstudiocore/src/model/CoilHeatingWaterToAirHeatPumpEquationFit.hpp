...
extern template class boost::optional<openstudio::model::CoilHeatingWaterToAirHeatPumpEquationFit>;
template<> std::vector<openstudio::model::CoilHeatingWaterToAirHeatPumpEquationFit>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::CoilHeatingWaterToAirHeatPumpEquationFit>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::CoilHeatingWaterToAirHeatPumpEquationFit>;
