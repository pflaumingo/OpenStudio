...
template class boost::optional<openstudio::model::AirTerminalSingleDuctConstantVolumeFourPipeInduction>;
template class std::vector<openstudio::model::AirTerminalSingleDuctConstantVolumeFourPipeInduction>;
