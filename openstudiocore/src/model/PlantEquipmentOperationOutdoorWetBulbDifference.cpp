...
template class boost::optional<openstudio::model::PlantEquipmentOperationOutdoorWetBulbDifference>;
template class std::vector<openstudio::model::PlantEquipmentOperationOutdoorWetBulbDifference>;
