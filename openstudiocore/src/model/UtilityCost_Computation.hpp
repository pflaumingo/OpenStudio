...
extern template class boost::optional<openstudio::model::UtilityCost_Computation>;
template<> std::vector<openstudio::model::UtilityCost_Computation>::vector(size_type) = delete; // do not instantiate
template<> void std::vector<openstudio::model::UtilityCost_Computation>::resize(size_type) = delete; // do not instantiate
extern template class std::vector<openstudio::model::UtilityCost_Computation>;
