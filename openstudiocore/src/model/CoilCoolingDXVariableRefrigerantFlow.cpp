...
template class boost::optional<openstudio::model::CoilCoolingDXVariableRefrigerantFlow>;
template class std::vector<openstudio::model::CoilCoolingDXVariableRefrigerantFlow>;
