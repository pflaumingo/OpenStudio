...
template class boost::optional<openstudio::model::SolarCollectorPerformanceFlatPlate>;
template class std::vector<openstudio::model::SolarCollectorPerformanceFlatPlate>;
