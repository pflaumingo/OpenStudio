...
template class boost::optional<openstudio::model::CoilHeatingLowTempRadiantConstFlow>;
template class std::vector<openstudio::model::CoilHeatingLowTempRadiantConstFlow>;
