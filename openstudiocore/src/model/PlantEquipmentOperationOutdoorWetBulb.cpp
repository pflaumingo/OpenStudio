...
template class boost::optional<openstudio::model::PlantEquipmentOperationOutdoorWetBulb>;
template class std::vector<openstudio::model::PlantEquipmentOperationOutdoorWetBulb>;
