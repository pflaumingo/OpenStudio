...
template class boost::optional<openstudio::model::CoilCoolingLowTempRadiantVarFlow>;
template class std::vector<openstudio::model::CoilCoolingLowTempRadiantVarFlow>;
