...
template class boost::optional<openstudio::model::PlantEquipmentOperationOutdoorDewpoint>;
template class std::vector<openstudio::model::PlantEquipmentOperationOutdoorDewpoint>;
