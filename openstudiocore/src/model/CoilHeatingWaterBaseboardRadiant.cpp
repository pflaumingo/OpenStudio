...
template class boost::optional<openstudio::model::CoilHeatingWaterBaseboardRadiant>;
template class std::vector<openstudio::model::CoilHeatingWaterBaseboardRadiant>;
