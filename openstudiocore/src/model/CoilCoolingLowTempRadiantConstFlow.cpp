...
template class boost::optional<openstudio::model::CoilCoolingLowTempRadiantConstFlow>;
template class std::vector<openstudio::model::CoilCoolingLowTempRadiantConstFlow>;
