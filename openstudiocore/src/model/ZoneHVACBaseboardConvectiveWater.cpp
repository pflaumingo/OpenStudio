...
template class boost::optional<openstudio::model::ZoneHVACBaseboardConvectiveWater>;
template class std::vector<openstudio::model::ZoneHVACBaseboardConvectiveWater>;
