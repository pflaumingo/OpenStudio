...
/** GumbelDistribution is an UncertaintyDescription that can apply aleatory uncertainty to a
 *  continuous variable. */
namespace detail {
class UncertaintyDescription_Impl;
}  // namespace detail

class ANALYSIS_API GumbelDistribution : public UncertaintyDescription {
 public:
  /** @name Constructors and Destructors */
  //@{

  /** Returns a Gumbel distribution with alpha of 1 and beta of 2. */
  GumbelDistribution();

  GumbelDistribution(double alpha, double beta);
 ...
 private:
  REGISTER_LOGGER("openstudio.analysis.GumbelDistribution");
};
