...
/** NegativeBinomialDistribution is an UncertaintyDescription that can apply aleatory uncertainty to a
 *  discrete variable. */
namespace detail {
class UncertaintyDescription_Impl;
}  // namespace detail

class ANALYSIS_API NegativeBinomialDistribution : public UncertaintyDescription {
 public:
 ...
 private:
  REGISTER_LOGGER("openstudio.analysis.NegativeBinomialDistribution");
};
